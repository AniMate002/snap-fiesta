                    ...
                    </InputGroup>
                    {
                        ...
                        :
                            <Box display={'flex'} alignItems={'center'} gap={3}>
                                <Text to='/auth/signUp' width={'max-content'} as={Link} color={'#ff436cff'} fontWeight={'bold'} rounded={'xl'} variant={'solid'}>Sign up</Text>
                                <Button as={Link} to='/auth/logIn' border={'2px solid black'} rounded={'xl'} variant={'ghost'}>Log in</Button>
                            </Box>
